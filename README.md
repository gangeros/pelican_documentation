...
**(вставить таблицу характеристик из важного)**
...
| Программное обеспечение для наземной станции управления QGroundControl
...
(вставить ТХ на пульт)

### Технические характеристики Пеликана
